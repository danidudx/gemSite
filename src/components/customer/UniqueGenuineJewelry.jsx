export default function UniqueGenuineJewelry() {
  const features = [
    {
      title: "Handcrafted Excellence",
      subtitle: "Artisan Craftsmanship",
      description:
        "Each piece is meticulously handcrafted by skilled artisans using traditional techniques passed down through generations, ensuring unparalleled quality and attention to detail.",
      icon: "✨",
    },
    {
      title: "Authentic Materials",
      subtitle: "Genuine Precious Stones",
      description:
        "We source only the finest authentic diamonds, gemstones, and precious metals from trusted suppliers worldwide, guaranteeing the authenticity and quality of every piece.",
      icon: "💎",
    },
    {
      title: "Unique Designs",
      subtitle: "One-of-a-Kind Collections",
      description:
        "Our exclusive designs blend timeless elegance with contemporary style, creating unique pieces that reflect your individual personality and stand out from the ordinary.",
      icon: "🌟",
    },
  ];
